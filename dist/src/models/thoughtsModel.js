...
const amendThoughtDetails = (db, id, updateDetails) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (Object.keys(updateDetails).includes("thoughtMessage")) {
        validThoughtMessage = /(?=.*[a-zA-Z]).{10,}$/.test(updateDetails.thoughtMessage);
    }
    if (Object.keys(updateDetails).includes("category")) {
    ...
    if (Object.keys(updateDetails).includes("userId") ||
        Object.keys(updateDetails).includes("_id")) {
        return Promise.reject({
            status: 400,
