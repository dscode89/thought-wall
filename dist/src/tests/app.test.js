...
//   test("Will return a JSON representation of the information relating to how a user can interact with the API.", () => {
//     return request(app)
//       .get("/api/endpoints")
//       .expect(200)
//       .then(({ body }) => {
...
describe("/api/users", () => {
    describe("GET", () => {
        test.only("GET: 200 - will return object containing a list of users", () => {
